...
void zandej_nahoru() {
  ...
  else if ( y_strana[1] == 'b' &&  y_strana[5] == 'b' &&  y_strana[7] == 'b' &&  y_strana[3] == 'b') {
...
void prepis_pole() {
  s.toCharArray(b_strana, sizeof(b_strana));
  delay(100);
...
void prijemdatgui() {
  ...
  prijmustr();
  prepis_pole();
  Serial.println("Data prijata úspěšně");
  stav_kostky();
  delay(1000);
